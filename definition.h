...
class Definition {
 ...
 public:
  ...
  /**
   * Method: getPossibleExpansions
   * -----------------------------
   * Returns a constant reference to the
   * embedded possibleExtensions.
   * 
   * @return an immutible reference to a vector, which stores
   *         the Production object.
   */
  const vector<Production>& getPossibleExpansions() const { return possibleExpansions; }
